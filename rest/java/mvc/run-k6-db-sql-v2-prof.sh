...
K6_USERS=200 K6_ITERATIONS=10000 SPRING_DATASOURCE_ENABLED=true NATIVE_JDBC_V2_ENABLED=true WRITE_PROFILE=true FLAMEGRAPH_FILE_OUT=flamegraph-sql-v2 ./run-k6.sh