...
public class TaskWebfluxController implements ReactiveTaskAPI<TaskImpl, TaskImpl, TaskImpl, OffsetDateTime> {

    private final ReactiveTaskService<TaskImpl, OffsetDateTime> service;
