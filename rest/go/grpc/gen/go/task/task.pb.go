...
func (x *TaskServiceGetResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *TaskServiceGetResponse) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *TaskServiceGetResponse) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *TaskServiceGetResponse) GetDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.Deadline
	}
	return nil
...
var file_task_v1_task_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x16, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x36, 0x0a, 0x08, 0x64, 0x65, 0x61, 0x64,
	...
	0x32, 0x72, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x63, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x1e, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x76, 0x31,
	...
	0x13, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2f, 0x7b, 0x69,
	0x64, 0x3d, 0x2a, 0x7d, 0x42, 0x5d, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x61, 0x73, 0x6b,
	0x2e, 0x76, 0x31, 0x42, 0x09, 0x54, 0x61, 0x73, 0x6b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
	0x5a, 0x06, 0x2e, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0xa2, 0x02, 0x03, 0x54, 0x58, 0x58, 0xaa, 0x02,
...
var file_task_v1_task_proto_goTypes = []any{
	(*TaskServiceGetRequest)(nil),  // 0: task.v1.TaskServiceGetRequest
	(*TaskServiceGetResponse)(nil), // 1: task.v1.TaskServiceGetResponse
	(*timestamppb.Timestamp)(nil),  // 2: google.protobuf.Timestamp
}
var file_task_v1_task_proto_depIdxs = []int32{
	2, // 0: task.v1.TaskServiceGetResponse.deadline:type_name -> google.protobuf.Timestamp
	0, // 1: task.v1.TaskService.Get:input_type -> task.v1.TaskServiceGetRequest
	1, // 2: task.v1.TaskService.Get:output_type -> task.v1.TaskServiceGetResponse
